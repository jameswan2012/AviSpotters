...
CREATE TABLE "new_Photo" (
    ...
    "replyLocale" TEXT NOT NULL DEFAULT 'zh-Hant',
    "staffNote" TEXT,
...
INSERT INTO "new_Photo" ("aircraftModel", "airline", "assignedReviewerId", "categoriesJson", "ccAgree", "clientUploadId", "createdAt", "description", "displayMime", "displayPath", "exifJson", "exifSummaryJson", "featured", "fileName", "fileSizeBytes", "firstReviewDecision", "firstReviewReason", "firstReviewedAt", "firstReviewedById", "height", "hot", "id", "msn", "originalMime", "originalPath", "priority", "reReviewReason", "reReviewRequestedAt", "reReviewRequestedById", "registration", "reviewDecision", "reviewReason", "reviewedAt", "reviewedById", "serialNumber", "shotAirport", "shotAt", "staffNote", "status", "thumbPath", "title", "updatedAt", "uploaderMessage", "userId", "watermarkJson", "width") SELECT "aircraftModel", "airline", "assignedReviewerId", "categoriesJson", "ccAgree", "clientUploadId", "createdAt", "description", "displayMime", "displayPath", "exifJson", "exifSummaryJson", "featured", "fileName", "fileSizeBytes", "firstReviewDecision", "firstReviewReason", "firstReviewedAt", "firstReviewedById", "height", "hot", "id", "msn", "originalMime", "originalPath", "priority", "reReviewReason", "reReviewRequestedAt", "reReviewRequestedById", "registration", "reviewDecision", "reviewReason", "reviewedAt", "reviewedById", "serialNumber", "shotAirport", "shotAt", "staffNote", "status", "thumbPath", "title", "updatedAt", "uploaderMessage", "userId", "watermarkJson", "width" FROM "Photo";
DROP TABLE "Photo";
