/*
  ...
  - You are about to drop the column `decidedAt` on the `PhotoAppeal` table. All the data in the column will be lost.
  - You are about to drop the column `decidedById` on the `PhotoAppeal` table. All the data in the column will be lost.
